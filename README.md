...
1. open STDR server `source /opt/ros/kinetic/setup.bash`,
 ...
   * now option 1 : `rosrun stdr_server stdr_server_node maps/<your_own_maze.yaml>`
   * or option 2 : `roscd stdr_resources` ---> `rosrun stdr_server load_map maps/<your_own_maze.yaml>`
